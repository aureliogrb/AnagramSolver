...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (cmd.hasOption("a")) {
                anagram = cmd.getOptionValue("a").toLowerCase();
            } else {
            ...
            if (cmd.hasOption("i")) {
                mustInclude = cmd.getOptionValue("i").toLowerCase();
            }
        ...
        try {
            System.out.println("Word count: " + anagramSolver(anagram
                    , minlength
                    , "/Users/Aurelio/Documents/git/AnagramSolver/src/main/resources/wordlist.txt"
                    ,mustInclude ));
